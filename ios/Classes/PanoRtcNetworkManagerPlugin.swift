//
//  PanoRtcNetworkManagerPlugin.swift
//  pano_rtc
//
...
class PanoRtcNetworkManagerPlugin: NSObject {
    private final weak var rtcEnginePlugin: SwiftPanoRtcPlugin?
    private var methodChannel: FlutterMethodChannel?
    private var eventChannel: FlutterEventChannel?
    private var eventSink: FlutterEventSink?
    private(set) lazy var manager: RtcNetworkManager = {
        let `manager` = RtcNetworkManager()
    ...
    func initPlugin(with registrar: FlutterPluginRegistrar) {
        methodChannel = FlutterMethodChannel(name: "pano_rtc/api_networkMgr", binaryMessenger: registrar.messenger())
        eventChannel = FlutterEventChannel(name: "pano_rtc/events_networkMgr", binaryMessenger: registrar.messenger())
        registrar.addMethodCallDelegate(self, channel: methodChannel!)
        eventChannel?.setStreamHandler(self)
    }
}

extension PanoRtcNetworkManagerPlugin: FlutterPlugin {
...
extension PanoRtcNetworkManagerPlugin: FlutterStreamHandler {
...
extension PanoRtcNetworkManagerPlugin: RtcNetworkManagerDelegate {
